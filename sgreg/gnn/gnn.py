...
from sgreg.gnn.triplet_gnn import TripletGNN, GetCornerIndices
from sgreg.gnn.spatial_attention import SpatialTransformer, CrossBlock
import time
...
if __name__=='__main__':
    print('Try init graph neural network')
    cfg_file = 'config/rio.yaml'
    conf = OmegaConf.load(cfg_file)
    gnn = GraphNeuralNetwork(conf.scenegraph)