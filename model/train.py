...
from model.config import create_cfg
from model.utils.torch import to_cuda, checkpoint_restore, checkpoint_save
from model.utils.utils import RecallMetrics, load_submodule_state_dict, summary_dict
from model.loss.eval import compute_node_matching, compute_registration
from sgnet import SGNet, SGNetDecorator
    ...
    for i, batch_data in enumerate(data_loader):
        ...
        with torch.no_grad():
            ...
            if save_dir != '' and batch_data['batch_size']==1:
                ...
                from model.utils.io import write_pred_nodes, write_registration_results
                
                # Correspondences
                from model.utils.utils import mask_valid_labels
